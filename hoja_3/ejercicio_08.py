...
frequencies =  {'C': 1.0, 'D': 1.12, 'E': 1.19, 'F':1.33 , 'G': 1.5, 'A': 1.59, 'B': 1.78}
...
while c!= 'q': 
    ...
    if kb.kbhit():
        c = kb.getch()
        if   (c =='z') : vel=frequencies['C']
        elif (c=='x')  : vel=frequencies['D']
        elif (c =="c") : vel=frequencies['E']
        elif (c == "v"): vel=frequencies['F']
        elif (c == "b"): vel=frequencies['G']
        elif (c == "n"): vel=frequencies['A']
        elif (c == "m"): vel=frequencies['B']
        sd.play(data,SRATE*vel)
